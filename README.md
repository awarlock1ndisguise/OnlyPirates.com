# 🏴‍☠️ OnlyPirates.com
> Going through websites can be more fun than you think.
## 💰 What is OnlyPirates.com ?
OnlyPirates.com is a quirky and unprofessional website that was created during GrizzHacks 8, Hackathon. At first glance, our website intends to despise the audience by presenting a pirate dating website for you to find "Hot Pirates in your area". But then it will take an unexpected turn as the user gets deeper into the website. Each page has a different annoying and time consuming feature that makes the user make useless tasks with not direct connection to the initial plot that you signed up for before accessing this website. 
## ✨ What motivated us?
